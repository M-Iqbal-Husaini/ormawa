            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="margin-bottom: 10px;">
                        <a href="{{route('guest.login')}}" style="color: #ffffff; text-decoration: none; transition: color 0.3s;">
                            <i style="margin-right: 8px; color: #ffcc00;"></i>Pendaftaran
                        </a>
                    </li>
                    <li style="margin-bottom: 10px;">
                        <a href="{{route('guest.berita')}}" style="color: #ffffff; text-decoration: none; transition: color 0.3s;">
                            <i style="margin-right: 8px; color: #ffcc00;"></i>Berita
                        </a>
                    </li>
                    <li style="margin-bottom: 10px;">
                        <a href="{{route('guest.organisasi')}}" style="color: #ffffff; text-decoration: none; transition: color 0.3s;">
