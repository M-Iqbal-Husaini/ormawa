                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="actionDropdown{{ $item->id }}">
                                        <a href="{{ route('divisi.detail', $item->id) }}" class="dropdown-item"><i class="fas fa-eye"></i> Detail</a>
                                        <a href="{{ route('divisi.edit', $item->id) }}" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
